...
import { Github, Linkedin, Mail, ExternalLink, Globe, Sparkles } from "lucide-react"
...
const CTAButton = memo(({ targetId, text, icon: Icon }) => {
  // Replace href with onClick handler for smooth scrolling
...
const Home = () => {
  ...
  const lottieOptions = {
    ...
    className: `w-full h-full transition-all duration-500 ${isHovering ? "scale-[180%]..." : "scale-[175%]..."}`
  };
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex flex-row gap-3 w-full justify-start" data-aos="fade-up" data-aos-delay="1400">
                  <CTAButton targetId="Portofolio" text="Projects" icon={ExternalLink} />
                  <CTAButton targetId="Contact" text="Contact" icon={Mail} />
                </div>
